...
public class MultiplayerMovement_2 : MonoBehaviour
{
    public InitialMovement movement;
    public PlayerTaskHandler taskHandler;
    ...
    public void OnFocus(CallbackContext context)
    {
        if (context.performed)
        {
            taskHandler.OnFocusPerformed(context);
        }

        else if (context.canceled)
        {
            taskHandler.OnFocusCancelled(context);
        }
